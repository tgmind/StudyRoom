...
export function IndicatorTag({ type, className = "" }: IndicatorProps) {
  ...
  if (type === "early") {
    return (
      <span
        className={`inline-flex items-center space-x-1 px-2 py-0.5 rounded text-[11px] font-medium bg-blue-950/40 border border-blue-800/40 text-blue-300 ${className}`}
